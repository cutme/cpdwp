...
function cutme_setup() {
	...
	add_image_size( 'blog', 468, 300, true );
	add_image_size( 'blog--retina', 936, 600, true );
	add_image_size( 'design-block', 565, 382, true );
	add_image_size( 'homecarousel', 1550, 1000, true );
	add_image_size( 'improve', 48, 48, true );
	add_image_size( 'improve--retina', 96, 96, true );
	add_image_size( 'pages-icon', 58, 58, true );
	add_image_size( 'pages-icon--retina', 116, 116, true );
	add_image_size( 'service-featured', 690, 1000, true );

    

	// Navigation
	register_nav_menus( array(
		'primary' => __( 'Main menu', 'cutme' ),
		'secondary' => __( 'Footer menu', 'cutme' )
	) );
